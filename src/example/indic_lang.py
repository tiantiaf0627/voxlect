...
if __name__ == '__main__':
    ...
    if pretrained_model == "mms-lid-256":
        log_dir = "/data2/tiantiaf/voxlect/log/accent/inla/mms-lid-256/lr00005_ep15_lora_64_accumulation_frozen"
        model = MMSWrapper(
        ...
        log_dir = "/data2/tiantiaf/voxlect/log/accent/inla/whisper_large/lr00005_ep15_lora_64_accumulation_frozen"
